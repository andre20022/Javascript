<template>
	<div id="app">
		<usuario-lista :usuarios="usuarios" :funcao="recuperaUsuario" />
    <usuario-detalhe :user="usuarioSeleciona"/> 
	</div>
</template>
...
export default {
  ...
  data() {
      return {
          ...
          usuarioSeleciona: null
      }
  },
  methods: {
    recuperaUsuario(usuario) {
      this.usuarioSeleciona = this.usuarios.find((user) => user.id === usuario.id);
    }
  },
}
</script>
